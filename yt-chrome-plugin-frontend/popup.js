...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyCxD3Rh_jviq2an607H69RZtEQjrIgjUso';  // Replace with your actual YouTube Data API key
  // const API_URL = 'http://my-elb-2062136355.us-east-1.elb.amazonaws.com:80';   
  const API_URL = 'http://ec2-54-221-175-255.compute-1.amazonaws.com:5000'; // Replace with your actual backend API URL
